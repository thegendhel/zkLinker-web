...
const getTransaction = async (txId) => {
    const result = await fetch(`https://api.zklinker.site/proof/${txId}`).then((res) => res.json())
    return result
}
                                        ...
                                        <TableBody>
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell className='w-[100%] max-w-[50vw] relative'>
                                                    <CodeHighlight code={JSON.stringify(transaction?.proof || {})} language='json' className='relative' copy={false} />
                                                </TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>Transformed</TableCell>
                                                <TableCell className='w-[100%] max-w-[50vw] relative'>
                                                    <CodeHighlight code={JSON.stringify(transaction?.transformed || {})} language='json' className='relative' copy={false} />
                                                </TableCell>
                                            </TableRow>
                                        </TableBody>
                                    </Table>
